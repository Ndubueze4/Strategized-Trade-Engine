...
**A terminal-based automated trading engine for MetaTrader 5**
...
| **🖥️ Terminal UI** | Rich terminal dashboard with live panels and rounded borders |
...
|-----------------|----------|------------|------------|
| **≥ $100** | Standard (Baron D Forex) | H1, M15, M5 | 1.0% |
...
|---------|------|---------|
| 2.0 | 2026-08-30 | Terminal UI, animated splash, Rich dashboard |
| 1.0 | 2026-08-25 | Initial SMC strategy engine |
